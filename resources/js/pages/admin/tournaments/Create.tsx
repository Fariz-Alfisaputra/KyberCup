            ...
            <div className="mx-auto max-w-4xl">
                ...
                <div className="rounded-xl border border-border bg-card p-6">
                    <div className="mb-6 flex items-center gap-3 border-b border-border pb-6">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-foreground">Detail Turnamen Baru</h2>
                            <p className="text-sm text-muted-foreground">Lengkapi informasi turnamen di bawah ini.</p>
                        </div>
                    </div>
