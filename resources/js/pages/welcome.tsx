            ...
            <div className="flex min-h-screen flex-col items-center bg-background p-6 text-foreground lg:justify-center lg:p-8">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        {auth.user ? (
                            <Link
                                href={dashboard()}
                                className="inline-block rounded-sm border border-border px-5 py-1.5 text-sm leading-normal text-foreground transition-colors hover:border-foreground/50"
                            >
                                Dashboard
                            </Link>
                        ) : (
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg border border-border bg-card p-6 pb-12 text-[13px] leading-[20px] shadow-xs lg:rounded-tl-lg lg:rounded-br-none lg:p-20">
                            <h1 className="mb-1 font-medium text-foreground">
                                Let's get started
                            </h1>
                            ...
                            <ul className="flex gap-3 text-sm leading-normal">
                                <li>
                                    <a
                                        ...
                                        target="_blank"
                                        className="inline-block rounded-sm border border-primary bg-primary px-5 py-1.5 text-sm leading-normal text-primary-foreground transition-colors hover:bg-primary/95"
                                    >
                                        Deploy now
                                    </a>
                                </li>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-muted lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg">
                            {/* Laravel Logo */}
                            <svg
                            ...
                            {/* 13 */}
                            <svg
                                className="relative -mt-[6.6rem] -ml-8 w-[438px] max-w-none [--stroke-color:var(--text-secondary)] lg:ml-0 dark:[--stroke-color:var(--accent-primary)]"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                ...
                                <g className="text-muted opacity-100 transition-all delay-400 duration-750 dark:text-muted starting:opacity-0 motion-safe:starting:-translate-x-[26px]">
                                    <mask
                                        id="path-2-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="25.3357"
                                ...
                                <g className="text-accent opacity-100 mix-blend-color transition-all delay-400 duration-750 dark:text-accent dark:mix-blend-hard-light starting:opacity-0 motion-safe:starting:-translate-x-[51px]">
                                    <mask
                                        id="path-3-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="51"
                                ...
                                <g className="text-muted opacity-100 mix-blend-multiply transition-all delay-400 duration-750 dark:text-muted dark:mix-blend-normal starting:opacity-0 motion-safe:starting:-translate-x-[78px]">
                                    <mask
                                        id="path-4-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="76.6643"
                                ...
                                <g className="text-muted opacity-100 mix-blend-hard-light transition-all delay-400 duration-750 dark:text-muted starting:opacity-0 motion-safe:starting:-translate-x-[102px]">
                                    <mask
                                        id="path-5-mask"
                                        maskUnits="userSpaceOnUse"
                                        x="102.329"
