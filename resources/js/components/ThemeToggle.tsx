    ...
    return (
        <button
            ...
            className={cn(
                ...
                isLightSide
                    ? 'bg-white border-blue-200 text-blue-700 hover:border-blue-500 hover:shadow-[0_0_15px_rgba(24,95,165,0.35)]'
                    : 'bg-neutral-900 border-red-900/50 text-[#00d4ff] hover:border-[#00d4ff]/60 hover:shadow-[0_0_15px_rgba(0,212,255,0.35)]',
            )}
        ...
        >
            ...
            <div
                className={cn(
                    ...
                    isLightSide ? 'bg-blue-500' : 'bg-cyan-400',
                )}
            />

            <div className="relative flex items-center gap-1.5 px-2 py-0.5 z-10">
                {/* Sliding active capsule */}
                <div
                    className={cn(
                        'absolute top-0.5 bottom-0.5 w-8 rounded-full transition-all duration-500 -z-10 ease-out',
                        isLightSide
                            ? 'left-0.5 bg-blue-600/15 border border-blue-500/20'
                            : 'left-[calc(100%-2.05rem)] bg-cyan-400/15 border border-cyan-400/20',
                    )}
                />
                ...
                <div
                    className={cn(
                        ...
                        isLightSide
                            ? 'opacity-100 scale-100 drop-shadow-[0_0_4px_rgba(24,95,165,0.6)]'
                ...
                <div
                    className={cn(
                        'transition-all duration-500',
                        !isLightSide
                            ? 'opacity-100 scale-100 drop-shadow-[0_0_4px_rgba(0,212,255,0.6)]'
                            : 'opacity-30 scale-90 hover:opacity-50',
                    )}
                >
                    <DarkSideIcon />
            ...
            <span
                className={cn(
                    'pr-2 text-xs font-semibold tracking-wider transition-all duration-300',
                    isLightSide ? 'text-blue-700' : 'text-[#00d4ff]',
                )}
